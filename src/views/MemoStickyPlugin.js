...
class StickyPlugin {
          ...
          case 'title':
            ...
            el.addEventListener('textChange', function () {
              if (el.tagName.toUpperCase() === 'INPUT') {
                ...
                Error('you just have title in input tag')
              }
            })
            break
          case 'content':
            ...
            el.addEventListener('textChange', function () {
              if (el.tagName.toUpperCase() === 'TEXTAREA') {
                ...
                Error('you just have content in textarea tag')
              }
            })
            break
          case 'modify':
          ...
          case 'setindex':
            ...
            el.addEventListener('change', function () {
              if (
                ...
                Error('you just have content in selectbox tag')
              }
            })
          ...
          case 'add':
            el.addEventListener ('click', function () {
              if (el.tagName.toUpperCase() === 'BUTTON') {
                ...
                Error('you just have content in button tag')
              }
            })
            break
          case 'remove':
            el.addEventListener('click', function () {
              if (el.tagName.toUpperCase() === 'BUTTON') {
                if (self.findMemo('id', self.selectedMemo) !== -1) {
                  ...
                  Error('Are you remove nothing Element?')
                }
              } else {
                Error('you just have content in button tag')
              }
  ...
  loadData () {
    localStorage.getItem(this.name) ? (this.memo = JSON.parse(localStorage.getItem(this.name))) : ''
  }
}
